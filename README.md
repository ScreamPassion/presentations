...
Второй формат: не ответы, а хорошо структурированные вопросы. Вброс, следствие, «а что если нет», и честная граница, где кончается наука и начинаемся мы.
...
Тексты и структура - совместная работа автора и ИИ по пятницам: вопросы, споры, проверка фактов и вёрстка. Картинки - генерация нейросетью (Nano Banana Pro) в собственном проекте автора, диаграммы в «Изобретаем хаос» посчитаны кодом. Каждый слайд проверяется на 1600×900 headless-браузером, все факты - из открытых источников, спорные величины помечены как оценки.

## Лицензия

Можно читать, копировать, использовать и передавать дальше со ссылкой на первоисточник. Хотите изменить или дополнить - welcome, pull requests приветствуются, как и звёзды. Форк можно, с указанием первоисточника. Подробнее в [LICENSE](LICENSE).
